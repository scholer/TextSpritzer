...
/**
 * Based on work by andrewgiang on 3/3/14.
 * Modified by clinta
 */
public class SpritzerTextView extends TextView implements View.OnClickListener {
    ...
    public void addSpritzText(String input){
        mSpritzer.addText(input);
    }
    ...
    public void setRemainingWordsListener(Spritzer.RemainingWordsListener listener) {
        mSpritzer.setRemainingWordsListener(listener);
    }

    public void setWordsRemainingToTriggerListener(int wordsRemaining) {
        mSpritzer.setWordsRemainingToTriggerListener(wordsRemaining);
    }

    public void setCallbackListener(Spritzer.CallBackListener listener) {
        mSpritzer.setCallBackListener(listener);
    }
    ...
    public int getMSRemainingInQueue() {
        return mSpritzer.getMSRemainingInQueue();
    }
}